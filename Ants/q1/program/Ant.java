...
public class Ant
{
    ...
    public void solve(String outputName, String seed) throws IOException
    {
    ...
    private void bestSolution(String outputName, String seed) throws IOException
    {
    	 FileWriter fileWriter = new FileWriter(outputName);
         PrintWriter printWriter = new PrintWriter(fileWriter);
         
         
         //print tour and length to output file
         printWriter.print("Tour: ");
         for (int i = 0; i < numberVertices; i++)
             printWriter.print(solution[i] + " ");
         printWriter.print(solution[0]);
         printWriter.println();
         printWriter.println("Length: " + length(solution));
        ...
        //print all extra information to output file
        printWriter.println();
        printWriter.println("Iterations: " + numberIterations);
        printWriter.println("Chemical Exponent: " + chemicalExponent);
        printWriter.println("Distance Exponent: " + distanceExponent);
        printWriter.println("Initial Deposit: "+ initialDeposit);
        printWriter.println("Deposit Constant: " + depositAmount);
        printWriter.println("Decay Rate: " + decayRate);
